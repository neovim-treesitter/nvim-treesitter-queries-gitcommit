# nvim-treesitter-queries-gitcommit

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gitcommit/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gitcommit/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gitcommit**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gitcommit",
...
- [ ] Changes are scoped to `gitcommit` — do not include files for other languages
